...
#define TR_AUX_SERIAL_MODES    "Debug\0      ""Spegling av S-Port""SBUS Trainer\0     "
#else
#define TR_AUX_SERIAL_MODES    "OFF\0        ""Spegling av S-Port""SBUS Trainer\0     "
#endif
#else
#define LEN_AUX_SERIAL_MODES   "\022"
#if defined(CLI) || defined(DEBUG)
...
#if defined(PCBTARANIS)
  #define TR_SF_SCREENSHOT    "Sk\201rmbild"
#else
...
#define LEN_VARIOSRC           "\005"
  ...
  #define TR_VTELEMSCREENTYPE          "Inget\0 ""Siffror""Staplar"
#else
  #define LEN_VTELEMSCREENTYPE   "\007"
...
#define TR_VKEYS               "Menu\0 ""Exit\0 ""Enter\0""Upp\0  ""Ned\0  ""H\202ger\0""V\201nst"
...
#define TR_BEEP_LENGTH         "Pip-l\201ngd"
#define TR_SPKRPITCH           "Pip-ton"
#define TR_HAPTIC_LABEL        "Vibrator"
#define TR_HAPTICSTRENGTH      "Styrka"
...
#define TR_POWEROFF            "\027St\201nger Av..."
...
#define TR_SELECT_MODE         "V\201lj l\201ge"
...
#define TR_SPEAKER_VOLUME      "Volym"
#define TR_LCD                 "LCD"
...
#define TR_CRSF_ARMING_MODE            "Aktivera m."
...
#define TR_TELEMETRY_NEWSENSOR "L\201gg till"
...
#define TR_LOWALARM            "L\200g-alarm"
...
#define TR_EEBACKUP            "s\201kerhetskopiera EEPROM"
#define TR_FACTORYRESET        "Factory reset"
#define TR_CONFIRMRESET        "Erase ALL models and settings?"
#define TR_TO_MANY_LUA_SCRIPTS "F\202r m\200nga Lua-scripts!"
...
#define TR_DISCOVER_SENSORS    INDENT "S\202k nya"
#define TR_STOP_DISCOVER_SENSORS INDENT "Avbryt s\202kning"
#define TR_DELETE_ALL_SENSORS  INDENT "Ta bort alla"
