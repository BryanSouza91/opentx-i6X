...
#define TR_AUX_SERIAL_MODES                  "Debug\0      ""Telem Pelik\0""SBUS Trainer"
#else
#define TR_AUX_SERIAL_MODES                  "OFF\0        ""Telem Pelik\0""SBUS Trainer"
#endif
#else
#define LEN_AUX_SERIAL_MODES   "\015"
#if defined(CLI) || defined(DEBUG)
#define TR_AUX_SERIAL_MODES          "Debug\0       ""S-Port Pelik\0""Telemetry\0   ""SBUS Trainer\0""LUA\0         "
#else
#define TR_AUX_SERIAL_MODES          "POIS\0        ""S-Port Pelik\0""Telemetry\0   ""SBUS Trainer\0""LUA\0         "
#endif
#endif
...
#define TR_DATETIME            "P\204IV:""AIKA:"
...
#define TR_HAPTICSTRENGTH      "Strength"
...
#define TR_GPS                 "GPS"
#define TR_RXCHANNELORD        TR("Def chan order","Default channel order")
...
#define TR_UNIT                "Unit"
#define TR_TELEMETRY_NEWSENSOR "Add a new"
