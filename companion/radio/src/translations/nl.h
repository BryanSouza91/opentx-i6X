...
#define TR_AUX_SERIAL_MODES                  "Debug\0       ""Telem Mirror\0""SBUS Leerling"
#else
#define TR_AUX_SERIAL_MODES                  "OFF\0         ""Telem Mirror\0""SBUS Leerling"
#endif
#else
#define LEN_AUX_SERIAL_MODES   "\015"
#if defined(CLI) || defined(DEBUG)
#define TR_AUX_SERIAL_MODES          "Debug\0       ""Telem Mirror\0""Telemetrie\0  ""SBUS Leerling""LUA\0         "
#else
#define TR_AUX_SERIAL_MODES          "UIT\0         ""Telem Mirror\0""Telemetrie\0  ""SBUS Leerling""LUA\0         "
#endif
#endif
...
#define LEN_VARIOSRC           "\004"
  ...
  #define TR_VTELEMSCREENTYPE          "Geen\0 ""Nums\0 ""Balken"
#else
  #define LEN_VTELEMSCREENTYPE "\006"
...
#define TR_SPKRPITCH           "Piep-Freq. +/-"
#define TR_HAPTIC_LABEL        "Haptic"
#define TR_HAPTICSTRENGTH      "Sterkte"
...
#define TR_INACTIVITYALARM     TR("Inactiviteit", INDENT "Inactiviteit na") //9XR-Pro
#define TR_MEMORYWARNING       "Geheugen laag"
#define TR_ALARMWARNING        TR("Al Geluid uit?", INDENT "Al het geluid uit?")
...
#else
#define TR_EEBACKUP            TR("Backup", "EEPROM backup => SD")
...
#define TR_LSW_HEADERS_DURATION        "Min. Duur"
...
#define TR_DISCOVER_SENSORS    INDENT "Ontdek nieuwe"
#define TR_STOP_DISCOVER_SENSORS INDENT "Stop ontdekking"
#define TR_DELETE_ALL_SENSORS  INDENT "Wis alle"
